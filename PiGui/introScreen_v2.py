...
class introScreen(QtGui.QWidget):
    ...
    def initUI(self):
        ...
        self.label.setGeometry(QtCore.QRect(550, 80, 71, 71))
        self.label.setText(_fromUtf8(""))
        self.label.setPixmap(QtGui.QPixmap(_fromUtf8("../Python_GUI/igem_logo.png")))
        self.label.setScaledContents(True)
        self.label.setObjectName(_fromUtf8("label"))
        self.label_2 = QtGui.QLabel(self)
        self.label_2.setGeometry(QtCore.QRect(510, 20, 181, 51))
        font = QtGui.QFont()
        ...
        self.label_3.setGeometry(QtCore.QRect(530, 160, 141, 51))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Rockwell"))
        font.setPointSize(48)
