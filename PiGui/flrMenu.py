...
# self implementation generated from reading ui file 'flrMenu.ui'
#
...
class flrMenu(QtGui.QWidget):
    def __init__(self):
        ...
        self.emissionWavelengthScrollBar.valueChanged.connect(self.emissionWavelengthSpinBox.setValue)
    ...
    def initUI(self):
        ...
        self.emissionWavelengthSpinBox = QtGui.QSpinBox(self)
        self.emissionWavelengthSpinBox.setGeometry(QtCore.QRect(270, 230, 111, 41))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        font.setPointSize(20)
        ...
        self.label_7.setGeometry(QtCore.QRect(390, 230, 81, 41))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        font.setPointSize(24)
        font.setBold(True)
...
"selection-background-color: rgb(170, 255, 255);"))
        ...
        self.emissionWavelengthScrollBar = QtGui.QScrollBar(self)
        self.emissionWavelengthScrollBar.setGeometry(QtCore.QRect(560, 230, 191, 31))
        self.emissionWavelengthScrollBar.setStyleSheet(_fromUtf8("background-color: rgb(85, 255, 127);"))
        self.emissionWavelengthScrollBar.setMinimum(400)
        self.emissionWavelengthScrollBar.setMaximum(700)
        self.emissionWavelengthScrollBar.setOrientation(QtCore.Qt.Horizontal)
        self.emissionWavelengthScrollBar.setObjectName(_fromUtf8("emissionWavelengthScrollBar"))
        self.line.raise_()
        self.label.raise_()
        self.label_2.raise_()
        self.label_3.raise_()
        ...
        self.emissionWavelengthScrollBar.raise_()
    ...
    def retranslateUi(self):
        ...
        self.label_6.setText(_translate("self", "Emission:", None))
