...
class flrMenu(QtGui.QWidget):
    def __init__(self):
        ...
        self.emissionScrollBar.valueChanged.connect(self.emissionWavelengthSpinBox.setValue)
...
"selection-background-color: rgb(170, 255, 255);"))
        ...
        self.emissionScrollBar = QtGui.QScrollBar(self)
        self.emissionScrollBar.setGeometry(QtCore.QRect(560, 230, 191, 31))
        self.emissionScrollBar.setStyleSheet(_fromUtf8("background-color: rgb(85, 255, 127);"))
        self.emissionScrollBar.setMinimum(1)
        self.emissionScrollBar.setMaximum(6500)
        self.emissionScrollBar.setOrientation(QtCore.Qt.Horizontal)
        self.emissionScrollBar.setObjectName(_fromUtf8("emissionScrollBar"))
        self.line.raise_()
        self.label.raise_()
        self.label_2.raise_()
        self.label_3.raise_()
