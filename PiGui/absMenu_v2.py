...
# self implementation generated from reading ui file 'absMenu_v2.ui'
#
...
class absMenu(QtGui.QWidget):
    ...
    def initUI(self):
        ...
        self.exposureTimeSpinBox.setGeometry(QtCore.QRect(310, 100, 111, 41))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        ...
        self.label_3.setGeometry(QtCore.QRect(470, 100, 141, 41))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        font.setPointSize(24)
        font.setBold(True)
        ...
        self.addProtocolButton.setEnabled(False)
