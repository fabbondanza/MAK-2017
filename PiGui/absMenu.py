...
class absMenu(QtGui.QWidget):
    def __init__(self):
        ...
        self.wavelengthScrollBar.valueChanged.connect(self.wavelengthSpinBox.setValue)
    ...
    def initUI(self):
        ...
        self.label_4.setGeometry(QtCore.QRect(20, 180, 311, 41))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        font.setPointSize(24)
        font.setBold(True)
        ...
        self.wavelengthSpinBox.setGeometry(QtCore.QRect(310, 180, 111, 41))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        font.setPointSize(20)
        ...
        self.label_5.setGeometry(QtCore.QRect(460, 180, 121, 41))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        font.setPointSize(24)
        font.setBold(True)
        ...
        self.wavelengthScrollBar = QtGui.QScrollBar(self)
        self.wavelengthScrollBar.setGeometry(QtCore.QRect(560, 190, 191, 31))
        self.wavelengthScrollBar.setStyleSheet(_fromUtf8("background-color: rgb(85, 255, 127);"))
        self.wavelengthScrollBar.setMinimum(400)
        self.wavelengthScrollBar.setMaximum(700)
        self.wavelengthScrollBar.setOrientation(QtCore.Qt.Horizontal)
        self.wavelengthScrollBar.setObjectName(_fromUtf8("wavelengthScrollBar"))
        self.label_4.raise_()
        self.label_2.raise_()
        self.line.raise_()
        self.label_3.raise_()
        ...
        self.wavelengthScrollBar.raise_()
