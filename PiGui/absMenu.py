...
class absMenu(QtGui.QWidget):
    ...
    def initUI(self):
        ...
        self.label_4.setGeometry(QtCore.QRect(20, 170, 201, 41))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        font.setPointSize(24)
        font.setBold(True)
        ...
        self.wavelengthSpinBox.setGeometry(QtCore.QRect(240, 170, 111, 41))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        font.setPointSize(20)
        ...
        self.label_5.setGeometry(QtCore.QRect(370, 170, 81, 41))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        font.setPointSize(24)
        font.setBold(True)
