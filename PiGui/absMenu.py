...
class absMenu(QtGui.QWidget):
    ...
    def initUI(self):
        ...
        self.exposureTimeSpinBox.setGeometry(QtCore.QRect(300, 100, 111, 41))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        ...
        self.label_2.setGeometry(QtCore.QRect(20, 100, 211, 41))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        ...
        self.label_3.setGeometry(QtCore.QRect(480, 100, 61, 41))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        font.setPointSize(24)
        font.setBold(True)
        ...
        self.wavelengthSpinBox.setGeometry(QtCore.QRect(260, 170, 111, 41))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        font.setPointSize(20)
        ...
        self.label_5.setGeometry(QtCore.QRect(430, 170, 71, 41))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Calibri"))
        font.setPointSize(24)
        font.setBold(True)
