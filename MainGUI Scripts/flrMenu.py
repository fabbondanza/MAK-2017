...
# self implementation generated from reading ui file 'flourescentintensity_menu.ui'
#
...
class flrMenu(QtGui.QWidget):
    ...
    def initUI(self):
        self.setObjectName(_fromUtf8("Flourescence Menu"))
        self.resize(593, 119)
        ...
        self.label_12.setGeometry(QtCore.QRect(210, 40, 31, 21))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Cambria"))
        font.setPointSize(10)
        ...
        self.label_6.setGeometry(QtCore.QRect(40, 20, 531, 91))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Cambria"))
        ...
        self.label_2.setGeometry(QtCore.QRect(40, 0, 191, 21))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Cambria"))
        ...
        self.label_11.setGeometry(QtCore.QRect(60, 40, 91, 21))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Cambria"))
        font.setPointSize(10)
        ...
        self.excitationBox.setGeometry(QtCore.QRect(130, 40, 71, 22))
        ...
        self.label_16.setGeometry(QtCore.QRect(60, 70, 71, 21))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Cambria"))
        font.setPointSize(10)
        ...
        self.label_17.setGeometry(QtCore.QRect(210, 70, 31, 21))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Cambria"))
        font.setPointSize(10)
        ...
        self.emissionBox = QtGui.QSpinBox(self)
        self.emissionBox.setGeometry(QtCore.QRect(130, 70, 71, 22))
        self.emissionBox.setMinimum(350)
        self.emissionBox.setMaximum(700)
        self.emissionBox.setObjectName(_fromUtf8("emissionBox"))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8("../Python_GUI/MoveDownLogo.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.moveDownButton.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8("../Python_GUI/MoveUpLogo.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self):
        self.setWindowTitle(_translate("Flourescence Menu", "Flourescence Menu", None))
        self.label_12.setText(_translate("Flourescence Menu", "(nm)", None))
        self.label_14.setText(_translate("Flourescence Menu", "(ms)", None))
        self.label_10.setText(_translate("Flourescence Menu", "Reading", None))
        self.label_15.setText(_translate("Flourescence Menu", " Max: 6500", None))
        self.label_2.setText(_translate("Flourescence Menu", "Fluorescent Intensity", None))
        self.label_13.setText(_translate("Flourescence Menu", "Exposure Time:", None))
        self.label_4.setText(_translate("Flourescence Menu", "Wavelength", None))
        self.label_11.setText(_translate("Flourescence Menu", "Excitation:", None))
        self.excitationBox.setItemText(0, _translate("Flourescence Menu", "Blue", None))
        self.excitationBox.setItemText(1, _translate("Flourescence Menu", "Green", None))
        self.excitationBox.setItemText(2, _translate("Flourescence Menu", "Orange", None))
        self.label_16.setText(_translate("Flourescence Menu", "Emission:", None))
        self.label_17.setText(_translate("Flourescence Menu", "(nm)", None))
