...
class absSpecMenu_Widget(QtGui.QWidget):
    def __init__(self):
        super(absSpecMenu_Widget, self).__init__()
        self.initUI()

    def initUI(self):
        self.setObjectName(_fromUtf8("Absorbance Spectrum"))
        self.resize(555, 109)
        ...
        self.label_12.setGeometry(QtCore.QRect(130, 40, 31, 21))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Cambria"))
        font.setPointSize(10)
        ...
        self.label_6.setGeometry(QtCore.QRect(10, 20, 531, 81))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Cambria"))
        ...
        self.startWave.setGeometry(QtCore.QRect(60, 40, 61, 22))
        ...
        self.label_16.setGeometry(QtCore.QRect(30, 70, 31, 21))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Cambria"))
        font.setPointSize(10)
        ...
        self.stopWave.setGeometry(QtCore.QRect(60, 70, 61, 22))
        self.stopWave.setMinimum(350)
        self.stopWave.setMaximum(700)
        self.stopWave.setObjectName(_fromUtf8("stopWave"))
        self.label_17 = QtGui.QLabel(self)
        self.label_17.setGeometry(QtCore.QRect(130, 70, 31, 21))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Cambria"))
        font.setPointSize(10)
    ...
    def retranslateUi(self):
        self.setWindowTitle(_translate("Absorbance Spectrum", "Absorbance Spectrum", None))
        self.label_12.setText(_translate("Absorbance Spectrum", "(nm)", None))
        self.label_14.setText(_translate("Absorbance Spectrum", "(ms)", None))
        self.label_10.setText(_translate("Absorbance Spectrum", "Reading", None))
        self.label_15.setText(_translate("Absorbance Spectrum", " Max: 6500", None))
        self.label_2.setText(_translate("Absorbance Spectrum", " Absorbance Spectrum", None))
        self.label_13.setText(_translate("Absorbance Spectrum", "Exposure Time:", None))
        self.label_4.setText(_translate("Absorbance Spectrum", "Wavelength", None))
        self.label_11.setText(_translate("Absorbance Spectrum", "Start:", None))
        self.label_16.setText(_translate("Absorbance Spectrum", "Stop:", None))
        self.label_17.setText(_translate("Absorbance Spectrum", "(nm)", None))
