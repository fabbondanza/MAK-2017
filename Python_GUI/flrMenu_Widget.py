...
class flrMenu_Widget(QtGui.QWidget):
    ...
    def initUI(self):
        ...
        self.excitationWave.setGeometry(QtCore.QRect(100, 40, 71, 22))
        ...
        self.emissionWave = QtGui.QSpinBox(self)
        self.emissionWave.setGeometry(QtCore.QRect(100, 70, 71, 22))
        self.emissionWave.setMinimum(350)
        self.emissionWave.setMaximum(700)
        self.emissionWave.setObjectName(_fromUtf8("emissionWave"))
    ...
    def retranslateUi(self):
        ...
        self.excitationWave.setItemText(0, _translate("Flourescent Intensity", "Blue", None))
        self.excitationWave.setItemText(1, _translate("Flourescent Intensity", "Green", None))
        self.excitationWave.setItemText(2, _translate("Flourescent Intensity", "Orange", None))
