...
class protocolMenu_Widget(QtGui.QWidget):
    ...
    def initUI(self):
        ...
        self.wellButton = QtGui.QPushButton(self.splitter)
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Cambria"))
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.wellButton.setFont(font)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("wellPlateLogo3.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.wellButton.setIcon(icon)
        self.wellButton.setIconSize(QtCore.QSize(40, 40))
        self.wellButton.setObjectName(_fromUtf8("wellButton"))
    ...
    def retranslateUi(self):
        ...
        self.wellButton.setText(_translate("Form", "Add Plate", None))
